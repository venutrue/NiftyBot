...
class BacktestEngine:
    ...
    def _get_weekly_expiry(self, reference_date):
        ...
        (Tuesday for NIFTY weekly since Nov 2024, or Monday for holiday adjustments).
        ...
        # Calculate next Tuesday from reference date (NIFTY weekly expiry since Nov 2024)
